...
void
SorobanTxData::publishSuccessMeta(TransactionMetaFrame& meta,
                                  Config const& cfg)
{
...
void
SorobanTxData::publishFailureMeta(TransactionMetaFrame& meta,
                                  Config const& cfg)
{
    if (cfg.EMIT_SOROBAN_TRANSACTION_META_EXT_V1)
    {
...
{
    return mEventManager; // Note: this is the existing member variable
}
