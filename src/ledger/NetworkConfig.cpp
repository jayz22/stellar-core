...
updateCpuCostParamsEntryForV22(AbstractLedgerTxn& ltxRoot)
{
    ...
    for (auto val : vals)
    {
        ...
        case VmInstantiation: 
            params[val] = ContractCostParamEntry(ExtensionPoint{0}, 31271, 57504);
            break;
        case VmCachedInstantiation: 
        ...
        case Bls12381G1Mul: 
            ...
            break;
        case Bls12381G1Msm: 
            params[val] = ContractCostParamEntry(ExtensionPoint{0}, 2426722, 96397671);
            break;
        case Bls12381MapFpToG1: 
            params[val] = ContractCostParamEntry(ExtensionPoint{0}, 1541554, 0);
            break;
        case Bls12381HashToG1: 
            params[val] = ContractCostParamEntry(ExtensionPoint{0}, 3211191, 6713);
            break;
        case Bls12381G2Add: 
        ...
        case Bls12381G2Mul: 
            ...
            break;
        case Bls12381G2Msm: 
            params[val] = ContractCostParamEntry(ExtensionPoint{0}, 8035968, 309667335);
            break;
        case Bls12381MapFp2ToG2: 
            params[val] = ContractCostParamEntry(ExtensionPoint{0}, 2420202, 0);
            break;
        case Bls12381HashToG2: 
            params[val] = ContractCostParamEntry(ExtensionPoint{0}, 7050564, 6797);
            break;
        case Bls12381Pairing: 
            params[val] = ContractCostParamEntry(ExtensionPoint{0}, 10558948, 632860943);
            break;
...
updateMemCostParamsEntryForV22(AbstractLedgerTxn& ltxRoot)
{
    ...
    for (auto val : vals)
    {
        ...
        case VmCachedInstantiation:
            params[val] =
                ContractCostParamEntry{ExtentionPoint{0}, 69472, 1478};
            break;
        case InvokeVmFunction:
            params[val] =
                ContractCostParamEntry{ExtentionPoint{0}, 15, 0};
            break;
        case ParseWasmInstructions:
            params[val] =
                ContractCostParamEntry{ExtentionPoint{0}, 13980, 215};
            break;
        case ParseWasmFunctions:
            params[val] =
                ContractCostParamEntry{ExtentionPoint{0}, 0, 23056};
            break;
        case ParseWasmGlobals:
            params[val] =
                ContractCostParamEntry{ExtentionPoint{0}, 0, 11924};
            break;
        case ParseWasmTableEntries:
            params[val] =
                ContractCostParamEntry{ExtentionPoint{0}, 0, 6121};
            break;
        case ParseWasmTypes:
            params[val] =
                ContractCostParamEntry{ExtentionPoint{0}, 0, 49554};
            break;
        case ParseWasmDataSegments:
            params[val] =
                ContractCostParamEntry{ExtentionPoint{0}, 0, 5525};
            break;
        case ParseWasmElemSegments:
            params[val] =
                ContractCostParamEntry{ExtentionPoint{0}, 0, 47034};
            break;
        case ParseWasmImports:
            params[val] =
                ContractCostParamEntry{ExtentionPoint{0}, 0, 101762};
            break;
        case ParseWasmExports:
            params[val] =
                ContractCostParamEntry{ExtentionPoint{0}, 0, 35491};
            break;
        case ParseWasmDataSegmentBytes:
            params[val] =
                ContractCostParamEntry{ExtentionPoint{0}, 0, 129};
            break;
        case InstantiateWasmInstructions:
            params[val] =
                ContractCostParamEntry{ExtentionPoint{0}, 70792, 0};
            break;
        case InstantiateWasmFunctions:
            params[val] =
                ContractCostParamEntry{ExtentionPoint{0}, 0, 17749};
            break;
        case InstantiateWasmImports:
            params[val] =
                ContractCostParamEntry{ExtentionPoint{0}, 0, 98578};
            break;

        // adding new cost types introduced in p22
        case Bls12381EncodeFp:
            params[val] =
                ContractCostParamEntry{ExtentionPoint{0}, 0, 0};
            break;
        case Bls12381DecodeFp:
            params[val] =
                ContractCostParamEntry{ExtentionPoint{0}, 0, 0};
        ...
        case Bls12381G1Msm:
            params[val] =
                ContractCostParamEntry{ExtentionPoint{0}, 109494, 354667};
            break;
        case Bls12381MapFpToG1:
            params[val] =
                ContractCostParamEntry{ExtentionPoint{0}, 5552, 0};
            break;
        case Bls12381HashToG1:
            params[val] =
                ContractCostParamEntry{ExtentionPoint{0}, 9424, 0};
            break;
        case Bls12381G2Add:
            params[val] =
                ContractCostParamEntry{ExtentionPoint{0}, 0, 0};
        ...
        case Bls12381G2Msm:
            params[val] =
                ContractCostParamEntry{ExtentionPoint{0}, 219654, 354667};
            break;
        case Bls12381MapFp2ToG2:
            params[val] =
                ContractCostParamEntry{ExtentionPoint{0}, 3344, 0};
            break;
        case Bls12381HashToG2:
            params[val] =
                ContractCostParamEntry{ExtentionPoint{0}, 6816, 0};
            break;
        case Bls12381Pairing:
            params[val] =
                ContractCostParamEntry{ExtentionPoint{0}, 2204, 9340474};
            break;
        case Bls12381FrFromU256:
            params[val] =
                ContractCostParamEntry{ExtentionPoint{0}, 0, 0};
        ...
        case Bls12381FrToU256:
            params[val] =
                ContractCostParamEntry{ExtentionPoint{0}, 248, 0};
            break;
        case Bls12381FrAddSub:
            params[val] =
                ContractCostParamEntry{ExtentionPoint{0}, 0, 0};
        ...
        case Bls12381FrPow:
            params[val] =
                ContractCostParamEntry{ExtentionPoint{0}, 0, 128};
            break;
        case Bls12381FrInv:
            params[val] =
                ContractCostParamEntry{ExtentionPoint{0}, 0, 0};
